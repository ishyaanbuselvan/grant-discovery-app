...
export const metadata: Metadata = {
  ...
  description: "Discover classical music grants, performing arts funding, and nonprofit arts opportunities. Luminarts offers AI research tools to analyze foundation websites, filter 150+ verified grants by deadline and budget, and export to Excel. Built for Friday Morning Music Club and arts organizations nationwide.",
  ...
  openGraph: {
    title: "Luminarts | AI-Powered Arts & Music Grant Discovery",
    description: "Discover classical music grants and performing arts funding with AI-powered research tools. Filter 150+ verified grants, analyze foundation websites, and export to Excel.",
